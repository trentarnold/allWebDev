...
const firstDeckTotalCardsText = document.querySelector('.first-deck');
const firstDeckElement =document.querySelector('.first-deck-card-played');
const secondDeckTotalCardsText = document.querySelector('.second-deck');
...
function checkRoundWin(firstPlayerCard, secondPlayerCard){
    ...
    const winner = firstPlayerCard.trueValue > secondPlayerCard.trueValue ? firstPlayerCard : secondPlayerCard;
